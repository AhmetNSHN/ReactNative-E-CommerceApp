...
export default function Login({ navigation }) {
  ...
  // useState Using
  const [ email, setEmail ] = useState("kaan3@mail.com")
  ...
  const fncLogin = () => {
    //setPassStatue(false)
    if ( email == '' ) {
        Alert.alert('E-Mail Empty!')
    }else if ( password == '' ) {
      Alert.alert('Password Empty!')
    }else {
      
      // https://www.jsonbulut.com/json/userLogin.php?ref=c7c2de28d81d3da4a386fc8444d574f2&userEmail=caner2@mail.com&userPass=Caner@12345&face=no
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.footerCard}>
        ...
        <Text style={ styles.footerCartText }> Neque porro quisquam est qui dolorem </Text>
      </View>
